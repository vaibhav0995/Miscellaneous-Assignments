...
public class EmployeeController {
	...
	public String addSkills(Model model,HttpServletRequest request) {
		String employeeCode = request.getSession().getAttribute("employeeCode").toString();
		model.addAttribute("employeeSkill",(employeeSkillsService.getEmployeeSkillsOfEmployee(employeeCode)));
		model.addAttribute("skillList",skillMasterService.getAllSkills());
		return "employee/addSkills";
	}
	
	@PostMapping("/addSkills")
	public String addSkills(@RequestParam("skillId") int id, HttpServletRequest request) {
